...
<div class="form-group">
    <label for="exampleInputEmail1">USERNAME/MAIL ID</label>
    <input type="text" class="form-control" id="text" name="text" aria-describedby="emailHelp" placeholder="Enter username/mail_id">
</div>
<div class="form-group">
