...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>AgriportalVIIT - Change The Way You Trade...</h1>
...
<img src="img/pja2.jpg" style="width: 100%;">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> ‘AgriPortalVIIT' is a model farmer management website application..</li>
              <li><i class="ri-check-double-line"></i> ‘AgriPortalVIIT’ provides a concept of virtual agricultural trade to its users.</li>
